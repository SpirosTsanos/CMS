...
namespace CMS.Tools
{
    public class BaseViewModel : INotifyPropertyChanged, INotifyDataErrorInfo, IViewModel
    {
        protected readonly Dictionary<string, List<string>> _errors = new Dictionary<string, List<string>>();

        public object Data { get; set; }

        public event EventHandler ReturnedToWelcomePage;
        ...
        protected virtual void OnReturnedToWelcomePage()
        {
            ReturnedToWelcomePage?.Invoke(this, new EventArgs());
        }
